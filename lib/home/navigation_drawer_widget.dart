...
class NavigationDrawerWidget extends StatefulWidget {
  NavigationDrawerWidget({Key? key,required this.name,
    required this.attendenceList,required this.leaveEmpList,
    required this.odEmpList,required this.personalInfo}) : super(key: key);
  String name;
...
class _HomePageState extends State<NavigationDrawerWidget> {
  ...
  Widget build(BuildContext context) {
   ...
   return  Scaffold(
       ...
       accountName: robotoTextWidget(textval: widget.name, colorval: AppColor.whiteColor,
           sizeval: 14, fontWeight: FontWeight.w600),
    accountEmail: const robotoTextWidget(textval:"1.0", colorval: AppColor.whiteColor,
        sizeval: 12, fontWeight: FontWeight.w600),
    decoration: const BoxDecoration(
    color: AppColor.themeColor,
    ),
    currentAccountPicture: CircleAvatar(
    backgroundColor: AppColor.whiteColor,
    child: robotoTextWidget(textval: widget.name[0], colorval: AppColor.themeColor,
        sizeval: 12, fontWeight: FontWeight.w600),
    ),
    ),
